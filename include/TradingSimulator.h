...
public:
	...
	double		mStartingCash{500000000};
	double		mMaxBuy{5000}; // don't spend more than 5k on any one stock
	double		mFirstBuy{2000}; // on the first buy, only 2k
	double		mRebuy{1000};		// on additoinal buys, 1k
